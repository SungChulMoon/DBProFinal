...
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>생산자 페이지</title>
...
<div id="header">
	...
	<div id="sub_menu">
		...
		<li><a href="ProductRegist.jsp">생산품 등록</a></li>
		<li><a href="ProductSearch.jsp">생산품 조회</a></li>
		</ul>
	</div>
	
	<div id="content">
		<div id="title">
			<h1><img src="./img/productor.png" height=350 alt=""/></h1>
		</div>
	</div>
