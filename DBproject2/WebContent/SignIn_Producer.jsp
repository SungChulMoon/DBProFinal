...
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>생산자 회원가입</title>
...
<div id="header">
	...
	<form action="producer_join">
		<fieldset style=>
			...
			<tr>
				<th scope="row"><label for="maincrops">주농작물</label></th>
				<td><select name="com_type" id="com_type" title="주농작물 선택">
			...
			<tr>
				<th scope="row"><label for="method">재배방법</label></th>
