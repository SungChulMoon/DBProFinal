...
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>판매자 로그인</title>
...
<div id="header">
	...
	<h3>판매자</h3>
		<ul>
		<li><a href="#">로그인</a></li>
		<li><a href="SignIn_Seller.jsp">회원가입</a></li>
		</ul>
	
	</div>

<div id="signupForm">
	<form class="signUp" action="seller_login">
	<fieldset>
		<h1 class="signUpTitle">판매자 로그인</h1>
		<input type="text" class="signUpInput1" name="id" 
			placeholder="Type your username" autofocus required> <input
			type="password" class="signUpInput" name="pass" placeholder="Choose a password"
			required> 
